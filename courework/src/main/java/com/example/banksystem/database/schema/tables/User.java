...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> SURNAME = createField(DSL.name("surname"), SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    /**
     * The column <code>public.user.location</code>.
     */
    public final TableField<UserRecord, String> LOCATION = createField(DSL.name("location"), SQLDataType.VARCHAR(50).nullable(false), this, "");
